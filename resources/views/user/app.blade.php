...
<html lang="en">
  <head>
    <title>Happy Collection &mdash;Happy Shopping</title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <h1><strong>HAPPY COLLECTION</strong></h1>
      ...
      <div class="container">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jl. A Yani No.45</li>
                <li class="phone">+62 8133 6213 900</li>
                <li class="email">niodyah30375@gmail.com</li>
              </ul>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> Proyek Akhir Pemrograman Web Lanjut |  <i class="icon-heart" aria-hidden="true"></i> by <target="_blank" class="text-primary">Nio Dyah Tribuana
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
