...
<div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        ...
        <h1 class="mb-2"><strong>Cari Kebutuhan Fashion Kamu hanya di Happy Collection</strong></h1>
        <h5 class="mb-2"><strong>Happy Collection, Happy Shopping.....</strong></h5>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Miliki fashion yang keren dan kekinian yang terjamin kualitasnya dan tentunya barangnya juga original bukan kw. </p>
            <p>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            ...
            <p>Kualitas barang dari store kami terjamin karena semua di sini original bukan kw.</p>
        </div>
        </div>
